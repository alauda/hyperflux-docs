...
Optionally, you can also deploy a rerank service using Alauda AI to improve the answer quality.
Checkout [Setup On-Premise Reranker Service](./setup-onprem-reranker.mdx) for detailed instructions.
